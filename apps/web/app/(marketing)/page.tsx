...
export default function Home() {
	...
	return (
		...
		>
			...
			>
				<div className="backdrop-blur-xl bg-background/60 border border-border/40 rounded-full px-6 py-3 shadow-lg">
					<div className="flex items-center gap-8">
						<Link
							href="/"
							className="flex items-center gap-2 hover:opacity-60 transition-opacity duration-300"
						>
							<Image src="/apple-icon.png" alt="WAV0" width={16} height={16} />
						...
						<Button
							asChild
							size="sm"
							className="bg-foreground text-background hover:bg-foreground/90 font-light text-[10px] uppercase tracking-[0.25em] rounded-full px-4 py-1.5 transition-all duration-300"
						>
							<Link href="/daw">Studio</Link>
						</Button>
					</div>
				</div>
			</motion.nav>
			...
			<section className="relative min-h-screen flex items-center justify-center pt-20">
				...
				<div className="relative z-10 max-w-6xl mx-auto text-center px-6 space-y-16">
					...
					>
						<h1 className="text-[clamp(3rem,12vw,10rem)] font-extralight tracking-tighter leading-[0.9] uppercase">
							Making Music
							<br />
							Production
							<br />
							<span className="text-muted-foreground/60">Accessible</span>
						</h1>
						<p className="text-sm md:text-base text-muted-foreground/80 max-w-lg mx-auto leading-relaxed font-light tracking-wide">
							Go from idea to sound in seconds, not hours. The first AI-native
							music studio that works entirely in your browser.
						</p>
					</motion.div>
					...
					<motion.div
						...
						className="inline-flex items-center gap-2 text-xs text-muted-foreground/60 font-light tracking-wider uppercase"
					>
			...
			<section id="features" className="relative px-6 py-32">
				<div className="max-w-5xl mx-auto">
					...
					>
						<h2 className="text-4xl md:text-6xl font-extralight tracking-tighter uppercase">
							Everything you need
						</h2>
						<p className="text-sm text-muted-foreground max-w-xl mx-auto font-light tracking-wide">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-border/30">
						{[
							...
							{
								title: "Studio",
								description: "A minimal AI-assisted DAW in your browser.",
							},
							{
								title: "Vault",
								description: "Secure storage with fine-grained access control.",
							},
							{
								title: "Version Control",
								description: "Branch, compare, and revert your generations.",
							},
						].map((feature, index) => (
							<motion.div
								key={feature.title}
								...
								viewport={{ once: true }}
								className="group p-8 bg-background hover:bg-muted/30 transition-all duration-500"
							>
