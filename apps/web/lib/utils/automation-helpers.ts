/**
 * App-specific Automation Helper Functions
 * Used by components for clip-relative automation, range operations, etc.
 *
 * Note: Core automation functions (addAutomationPoint, removeAutomationPoint, etc.)
 * are available via `automation` namespace from @wav0/daw-sdk
 */
