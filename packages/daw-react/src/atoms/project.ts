/**
 * Project-level atoms (markers, grid, musical metadata)
 */
...
import type { ProjectMarker, TimelineSection } from "@wav0/daw-sdk";

export const markersAtom = atomWithStorage<ProjectMarker[]>(
	"daw-project-markers",
	[],
);

export const sectionsAtom = atomWithStorage<TimelineSection[]>(
	"daw-project-sections",
	[],
);

export const gridAtom = atomWithStorage("daw-grid", {
...
export const musicalMetadataAtom = atomWithStorage("daw-musical-metadata", {
	tempoBpm: 120,
